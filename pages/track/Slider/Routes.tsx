						...
						<View className="ml-2 flex grow">
							<View className="flex-row h-[100px] items-center">
								<View className="grow flex pt-2">
									...
									<Text className="text-base font-bold leading-5 text-gray-black">{route.stations[0].station}</Text>
						...
						<View className="ml-2 my-[22px] mr-[30px] flex grow">
							...
							{expand && (
								<View className="mt-2.5">
									{route.stations.map(({ station, time, line }, i) => {
										if (i != 0 && i != route.stations.length - 1) {
											return (
												<View className="flex-row items-center">
													<View className="w-[30px] mr-2.5 flex-row items-center justify-center">
														{line.map((jeep, i) => (
															<>
																{jeep === 'a' ? <A /> : <B />}
													...
													<Text className="text-gray-dark leading-5 text-xs grow">{station}</Text>
